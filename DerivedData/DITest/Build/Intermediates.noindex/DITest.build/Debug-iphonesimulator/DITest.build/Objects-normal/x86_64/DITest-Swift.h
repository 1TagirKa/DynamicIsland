...
#ifndef DITEST_SWIFT_H
#define DITEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DITest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6DITest8Animator")
...
SWIFT_CLASS("_TtC6DITest11AppDelegate")
...
SWIFT_CLASS("_TtC6DITest13SceneDelegate")
...
SWIFT_CLASS("_TtC6DITest20SecondViewController")
...
SWIFT_CLASS("_TtC6DITest31TransitionDIAnimationController")
@interface TransitionDIAnimationController : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface TransitionDIAnimationController (SWIFT_EXTENSION(DITest)) <UIViewControllerAnimatedTransitioning>
- (NSTimeInterval)transitionDuration:(id <UIViewControllerContextTransitioning> _Nullable)transitionContext SWIFT_WARN_UNUSED_RESULT;
- (void)animateTransition:(id <UIViewControllerContextTransitioning> _Nonnull)transitionContext;
@end


SWIFT_CLASS("_TtC6DITest14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(DITest)) <UIViewControllerTransitioningDelegate>
